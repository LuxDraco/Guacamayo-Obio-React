...
<div id="app">
    ...
    <div class="modal fade" id="modalRegistro" tabindex="-1" role="dialog" aria-labelledby="exampleModalRegistro" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title font-weight-bold" id="exampleModalLongTitle">Registro</h5>
                ...
                <div class="modal-body">
                    <div class="d-flex justify-content-start align-items-center w-100">
                        <form id="formRegistro" class="w-100" method="POST" action="{{ route('register') }}">
                            @csrf
                ...
                <div class="modal-footer">
                    <button
                        ...
                        onclick="document.getElementById('formRegistro').submit()"
                    >
                        Registrar
                    </button>
                </div>
            ...
            <div class="d-flex flex-grow-1 justify-content-end h-50">
                <div class="rounded-pill d-flex justify-content-around align-items-center px-5 py-1 h-100"
                    ...
                    @guest
                        ...
                        <button class="btn btn-link btn-link-custom" data-toggle="modal" data-target="#modalRegistro">
                            Registrar
                        </button>
                    @else
                        <div
